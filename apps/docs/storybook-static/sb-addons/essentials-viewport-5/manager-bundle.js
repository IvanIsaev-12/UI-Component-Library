	...
	(() => {
		...
		var $ = Se(ae()),
			...
			Oe = {
				...
				tablet: a.createElement(le, null),
				...
				return a.createElement(
					...
					a.createElement(
						...
						a.createElement(
							...
							t !== P
								? a.createElement(xe, null, t.name, " ", c ? "(L)" : "(P)")
								: null
						)
					),
					a.createElement(j, {
			...
			Ge = Q(function () {
				...
				let n =
						...
						D,
					I = ee(),
					r = Ue(I.current, n.styles, e.viewportRotated);
				return (
					O(() => {
						I.current = r;
					}, [n]),
						...
						: a.createElement(
								...
								a.createElement(
									W,
									{
										placement: "top",
										tooltip: ({ onHide: u }) =>
											a.createElement(q, { links: Ve(d, n, t, u) }),
										closeOnOutsideClick: !0,
										onVisibleChange: m,
									},
									a.createElement(
