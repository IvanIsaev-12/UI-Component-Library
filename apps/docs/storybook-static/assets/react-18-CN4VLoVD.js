import { a as Qh, r as ei } from "./index-ZH-6pyQh.js";
import { r as Xh } from "./index-DVyBTwwr.js";
		...
		switch (a) {
			...
			case "option":
				for (var E in t)
					if (
						((d = t[E]),
						t.hasOwnProperty(E) && d != null && !u.hasOwnProperty(E))
					)
						switch (E) {
							case "selected":
								l.selected = !1;
			...
			case "link":
				...
				switch (a.rel) {
					case "stylesheet":
						return (
							(l = a.disabled),
							typeof a.precedence == "string" && l == null
						);
					default:
						return !0;
				}
