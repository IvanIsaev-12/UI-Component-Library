import{R as r}from"./iframe-CBzO8dBs.js";import{R as o}from"./DropdownMenu-COMoRqmJ.js";import"./preload-helper-Dp1pzeXC.js";import"./index-99C54_7m.js";import"./index-RaGzyqEA.js";const d={title:"Components/Progress",component:o,tags:["autodocs"],argTypes:{value:{control:{type:"range",min:0,max:100,step:1},description:"Current progress value"},maximum:{control:{type:"number"},description:"Maximum value"},variant:{control:{type:"select"},options:["primary","success","warning","danger"],description:"Visual variant"},size:{control:{type:"select"},options:["sm","md","lg"],description:"Size of the progress bar"}}},e={args:{value:60,maximum:100,variant:"primary",size:"md",label:"Progress"},render:n=>r.createElement("div",{className:"w-[600px]"},r.createElement(o,{...n}))};var a,s,t;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
    value: 60,
    maximum: 100,
    variant: "primary",
