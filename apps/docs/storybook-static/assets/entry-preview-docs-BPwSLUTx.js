...
import { r as Ge, R as ft } from "./index-ZH-6pyQh.js";
					...
					for (
						...
						if (P.node) {
							if (
								...
								return;
							if ((v.push($), B.push(P), this.__state === h || V === h))
								continue;
							if (
								((j = P.node),
								(M = j.type || P.wrap),
									...
									if (((we = ne[U]), (se = P[we]), !!se))
										if (Array.isArray(se)) {
											for (Q = se.length; (Q -= 1) >= 0; )
												if (se[Q]) {
													if (E(j, ne[U]))
														V = new A(se[Q], [we, Q], "Property", new F(se, Q));
													else if (D(se[Q]))
														V = new A(se[Q], [we, Q], null, new F(se, Q));
													else continue;
													v.push(V);
												}
								...
								(l.left.type === t.VariableDeclaration
									? ae(function () {
											(c.push(l.left.kind + pe()),
												c.push(
													d.generateStatement(l.left.declarations[0], yt)
												));
										})
...
` && (d = ["{"]),
									...
									var I, T, O, X;
									for (
										X = re, l & se && (X |= ue), I = 0, T = i.body.length;
										I < T;
										++I
									)
										(B &&
...
` && (d = ["{"])),
						...
						ExpressionStatement: function (i, l) {
							...
							function I(T) {
								...
								for (
									X = 6, ce = T.length;
									X < ce && u.code.isWhiteSpace(T.charCodeAt(X));
									++X
								);
					...
					(oe.Expression = {
									...
									ae(function (T) {
										...
										for (O = 0, X = i.elements.length; O < X; ++O)
											(i.elements[O]
												? (d.push(k ? T : ""),
													d.push(
														I.generateExpression(i.elements[O], r.Assignment, R)
													))
						...
						ImportSpecifier: function (i, l, a) {
							var c = i.imported,
								...
								k = i.local;
							return (
								k && k.name !== c.name && d.push(pe() + "as" + pe() + Ae(k)),
								d
							);
						},
					...
					for (
						...
						if (
							...
							if (o) {
								...
								((h.expression = u),
									(u = this.finishNode(h, "ChainExpression")));
							}
							return u;
						}
						e = u;
						...
						p
							.map(function (b, S) {
								var L = p.length - 1 === S ? C.newLine : "," + C.newLineOrSpace,
									_ = h(b, A, g + A.indent);
								return (
									A.transform && (_ = A.transform(p, S, _)),
									C.indent + _ + L
								);
							})
							.join("") +
...
var Ku = (e, t) => {
		...
		for (let u = 0; u < (t == null ? void 0 : t.skip); u += 1) {
			if (typeof r > "u")
				return (vt.warn("Cannot skip undefined element"), null);
