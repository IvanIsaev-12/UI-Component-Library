import{R as e}from"./index-ZH-6pyQh.js";import{E as a}from"./index-CWnBjDi5.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-jyNdYUlS.js";import"./index-DVyBTwwr.js";const h={title:"Primitives/Switch",component:a,tags:["autodocs"]},s={args:{size:"md"},render:f=>e.createElement("div",{className:"flex items-center gap-2"},e.createElement(a,{id:"mobile-data",...f}),e.createElement("label",{htmlFor:"mobile-data",className:"text-sm font-medium cursor-pointer"},"Mobile Data"))},t={render:()=>e.createElement("div",{className:"space-y-4"},e.createElement("div",{className:"flex items-center gap-2"},e.createElement(a,{id:"sm",size:"sm"}),e.createElement("label",{htmlFor:"sm",className:"text-sm"},"Small")),e.createElement("div",{className:"flex items-center gap-2"},e.createElement(a,{id:"md",size:"md"}),e.createElement("label",{htmlFor:"md",className:"text-sm"},"Medium")),e.createElement("div",{className:"flex items-center gap-2"},e.createElement(a,{id:"lg",size:"lg"}),e.createElement("label",{htmlFor:"lg",className:"text-sm"},"Large")))},l={render:()=>e.createElement("div",{className:"space-y-4"},e.createElement("div",{className:"flex items-center gap-2"},e.createElement(a,{id:"disabled-off",disabled:!0}),e.createElement("label",{htmlFor:"disabled-off",className:"text-sm"},"Always Off")),e.createElement("div",{className:"flex items-center gap-2"},e.createElement(a,{id:"disabled-on",disabled:!0,defaultChecked:!0}),e.createElement("label",{htmlFor:"disabled-on",className:"text-sm"},"Always On")))};var m,r,i;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    size: "md"
  },
