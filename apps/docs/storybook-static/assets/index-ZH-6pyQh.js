import { g as V } from "./_commonjsHelpers-CqkleIqs.js";
function F(a, T) {
...
function tt() {
	...
	return (
		...
		(r.isValidElement = S),
		(r.lazy = function (t) {
			return { $$typeof: O, _payload: { _status: -1, _result: t }, _init: X };
		}),
		(r.memo = function (t, e) {
...
var L = et();
const rt = V(L),
	ut = F({ __proto__: null, default: rt }, [L]);
export { rt as R, et as a, ut as o, L as r };
